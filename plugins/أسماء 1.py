...
OFFLINE_TAG = "𝑫𝑬𝑽 𝑺𝑨𝑺𝑨 𓅃"


@zedub.zed_cmd(
    pattern="اسمي هانتر$",
    command=("اسمي هانتر", plugin_category),
    info={
...
async def pussy(event):
    ...
    await edit_or_reply(event, "**جـاري وضع اسم مــصــــطــــــفــــــى على حسابـك**")
    photo = "./temp/donottouch.jpg"
    if not os.path.isdir("./temp"):
        os.mkdir("./temp")
    urllib.request.urlretrieve(
        "https://i.ibb.co/8xkN41z/aa4f62893f2a.jpg", photo
    )
    if photo:
