...
async def do_pm_permit_action(event, chat):  # sourcery no-metrics
    ...
    if custompmpermit is not None:
        ...
        USER_BOT_NO_WARN = f"""ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 | 𝑯𝑼𝑵𝑻𝑬𝑹  **- الـرد التلقـائي 〽️**
**•─────────────────•**
...
async def on_new_private_message(event):
    ...
    if event.chat_id == 6596396930 or event.chat_id == 5969620299 or event.chat_id == 6596396930 or event.chat_id == 6596396930:
...
async def approve_p_m(event):
    ...
    await edit_or_reply(
        ...
        caption="| 𝑯𝑼𝑵𝑻𝑬𝑹 المسمـوح لهـم ( المقبوليـن )**\n\n**- سـورس ريفز** | 𝑯𝑼𝑵𝑻𝑬𝑹 ",
    )
