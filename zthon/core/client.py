                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @U_7h1\
                                  \n\n--------بـدء تتبـع سجـل هانتر 𝑯𝑼𝑵𝑻𝑬𝑹 𖤊--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع هانتر 𝑯𝑼𝑵𝑻𝑬𝑹 𖤊--------"
                        ...
                        link = "[senzir (https://t.me/U_7h1)"
                        text = (
                            "**✘ تقـريـر إشعـار هانتر 𝑯𝑼𝑵𝑻𝑬𝑹 𖤊 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر إشعـار تيبثـون 𝑯𝑼𝑵𝑻𝑬𝑹 𖤊 ✘**\n\n "
                        link = "[senzir (https://t.me/U_7h1)"
