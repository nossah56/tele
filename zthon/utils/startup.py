    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://i.ibb.co/8xkN41z/aa4f62893f2a.jpg",
                
                caption="**•✘┊تـم بـدء تشغـيل سـورس هانتر الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝑺𝑶𝑼𝑹𝑪𝑬| 𝑯𝑼𝑵𝑻𝑬𝑹", "https://t.me/huntersource"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "هانتر❤️")
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/sasa.jpg")

        _, groupid = await create_supergroup(

            "كـروب السجـل هانتر", zedub, Config.TG_BOT_USERNAME, descript, photozed
    ...
    if PM_LOGGER_GROUP_ID != -100:
        ...
        photozed = await zedub.upload_file(file="zedthon/malath/sasa2.jpg")
