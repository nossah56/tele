...
async def _(event):
    ...
    zed_dev = 6596396930(, 6596396930, 6596396930, 5969620299
    if user.id in zed_dev:
        await event.reply(f"يب منصب √")


@zedub.on(events.NewMessage(pattern="/عمك"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6705610641, 5969620299, 6596396930)
    if user.id in zed_dev:
        await event.reply(f"أهلًا بك عزيزي المطور")


@zedub.on(events.NewMessage(pattern="/بخ"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6596396930, 6705610641)
    if user.id in zed_dev:
        await event.reply(f"مبرمج السورس يمر")
        
        
@zedub.on(events.NewMessage(pattern="/هانتر"))
async def _(event):
    user = await event.get_sender()
    zed_dev = (6596396930, 6596396930, 6596396930, 452840681)
    if user.id in zed_dev:
