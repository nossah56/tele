...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝑯𝑼𝑵𝑻𝑬𝑹  - بوت بروكسي هانترمجانا ](t.me/huntersource) 𓆪\n\n"
    "⪼ 💎يوزر بوت بروكسي هانترمجانا\n"
    "⪼ 💎𝐔𝐒𝐄𝐑 @brksey_bot\n"
    "\n𓆩 [𐇮 𝑯𝑼𝑵𝑻𝑬𝑹  𝑫𝑬𝑽](t.me/U_7h1) 𓆪"
    "\n𓆩 [𐇮 ⧛ماندو 𐇮](t.me/M_2A_E_S) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت هانترانتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت هانترانتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت هانتر انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
    msg = await edit_or_reply(zedevent, output)
