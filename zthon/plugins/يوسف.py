...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲  𝑯𝑼𝑵𝑻𝑬𝑹 - اوامــر المطـور المســاعد](t.me/huntersource) 𓆪\n\n"
    ...
    "\n𓆩 [𐇮 𝑯𝑼𝑵𝑻𝑬𝑹  𝑫𝑬𝑽 الهہـيـٖ͡ـ͢ـبـه 𐇮](t.me/U_7h1) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت هانتر انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن  𝑯𝑼𝑵𝑻𝑬𝑹 :**\n\n"
