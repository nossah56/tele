...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت  هانتر"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝑯𝑼𝑵𝑻𝑬𝑹  𝑫𝑬𝑽 ─┄─┄─┄─⋆"
zed_dev = ( 6596396930, 5969620299)
zel_dev = (6596396930, 5969620299)
zelzal = (6596396930, 5969620299)
